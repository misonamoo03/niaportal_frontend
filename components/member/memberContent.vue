<template>
	<div class="container">
		...
		<ul class="tab">
			<li :class="{ current: pageName === 'signIn' }" data-tab="tab1">
			...
			<li :class="{ current: pageName === 'findPass' }" data-tab="tab3">
		...
		<div
			id="tab1"
			:class="{ tabcontent: true, current: pageName === 'signIn' }"
		>
		...
		<div
			id="tab2"
			:class="{ tabcontent: true, current: pageName === 'signUp' }"
		>
			<div class="member_form_wrap">
				<input
					type="email"
		...
		<div
			id="tab3"
			:class="{ tabcontent: true, current: pageName === 'findPass' }"
		>
			<div class="member_form_wrap">
				<input
					type="email"
