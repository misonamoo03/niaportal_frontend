			...
			<nav role="navigation">
				<ul id="main-menu">
					<li>
						<a href="#">AI데이터</a>
						<ul id="sub-menu">
							<li><NuxtLink to="/sports/CD004001">골프데이터</NuxtLink></li>
							<li><NuxtLink to="/sports/CD004002">축구데이터</NuxtLink></li>
							<li><NuxtLink to="/sports/CD004003">농구데이터</NuxtLink></li>
						</ul>
					</li>
					<li>
						<a href="#">AI게시판</a>
						<ul id="sub-menu">
							<li><NuxtLink to="/board/faq/100">고객문의</NuxtLink></li>
							<li><NuxtLink to="/board/qna/200">FAQ</NuxtLink></li>
						</ul>
					</li>
				</ul>
			</nav>
				...
				<ul id="main-menu" v-else>
					...
					<li class="util_login"><a href="#">{{name}}님 <span class="util_arrow"><img src="~assets/images/login_arrow.png" alt="util_arrow"></span></a>
						<ul id="sub-menu" class="util_2depth">
							...
							<li><a href="/" aria-label="submenu" @click="logoutMethod">로그아웃</a></li>
						</ul>
					</li>
				</ul>
			</div>
